...
use cosmwasm_std::{
    ...
    IbcReceiveResponse, Reply, Response, Uint128, Coin, coins, SubMsgResult 
};
...
impl OracleRequestPacket {
    pub fn new(client_id: String, oracle_script_id: i64, calldata: Vec<u8>, ask_count: i64, min_count: i64, denom: String, amount: u128, prepareGas:i64, executeGas: i64) -> Self {
